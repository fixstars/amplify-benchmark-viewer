    ...
    Object.entries(results).map(([label, result]) => {
      result.map((item) => {
        ...
        problemData.push({
          ...
          label,
          '0%': item.time_to_solution['0%'],
          '1%': item.time_to_solution['1%'],
          '5%': item.time_to_solution['5%'],
          '10%': item.time_to_solution['10%'],
          '20%': item.time_to_solution['20%'],
          '50%': item.time_to_solution['50%'],
        })
      })
    })
  })
